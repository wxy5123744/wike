...
<div class="page_title">
    ...
    <div class="tool">
        ...
        <a  class="here" href="index.php?r=prom/service">商品宣传</a>
    </div>
</div> 
    <div>
  ...
  <div class="box post">
    <div class="tabcon">
      ...
      <div class="detail">
       <form name="frm_config_basic" id="frm_config_basic" action="index.php?do=prom&view=config&op=service" method="post">
                      ...
                      <td>
                         	如果沒有绑定行业,则默认为所有行业<br/><!-- 
                               <input type="checkbox" name="ckb_indus" value="1">绑定行业 -->
                           		   		<input type="hidden" name="hdn_indus_id" id="hdn_indus_id" value="460">
...
<select name="s_indus_select[]" id="s_indus_select" multiple="multiple" style="width:160px;float:left;height:200px;overflow-y:scroll;background:white;border:#ccc solid 1px;margin-left:20px;">
          <option id="s_indus_select_op_460" value="460" selected="selected"></option>  </select>
<br class="clear">
                 ...
                 <tr>
                    <th><font style="text-align:right">指定任务模型</font></th>
                       <td>只有指定模型下的被绑定的行业才会被推广<br/>
                         <label for="model_威客作品">
<input type="checkbox" id="model_威客作品" name="ckb_model[]" value="6" checked="checked">
                            		限定威客作品</label><br>
                         <label for="model_威客服务">
<input type="checkbox" id="model_威客服务" name="ckb_model[]" value="7" >
                            		限定威客服务</label><br>
                                                </td>
</tr>
            <tr>
                    <th scope="row">
                       商品推广收益                    </th>
                    <td>
                        <input type="text" size="15" class="txt" name="service_rate" value="10" maxlength="5" />%
                          (网站在商品订单交易的提成中指定的百分比给商品推广人)
                    </td>
               </tr>
                  <tr>
                   <th scope="row"> &nbsp;</th>
