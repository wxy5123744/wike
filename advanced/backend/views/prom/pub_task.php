...
<div class="page_title">
    <h1>推广配置管理</h1>
    <div class="tool">
        <a  href="index.php?r=prom/config">邀请注册</a>
        <a class="here"  href="index.php?r=prom/pub_task">发布推广</a>
    ...
    <div>
        <div class="box tip clearfix p_relative">
            ...
            <div class="detail pad10">
                <ul>
                    <li>
                    	                     	   任务是威客站点核心主题，可做单独事项进行推广，推手获一次性返利，优先级高于邀请注册的长久返利关系。建议站长加大返利比例，以获得更佳的推广氛围。                    </li>
                </ul>
            </div>
        </div>
  <div class="box post">
    <div class="tabcon">
      ...
      <div class="detail">
       <form name="frm_config_basic" id="frm_config_basic" action="index.php?do=prom&view=config&op=pub_task" method="post">
         <input type="hidden" name="op" value="pub_task">
            <div class="gut">
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                 <tr>
                    <th scope="row"><input type="hidden" name="pub_task" value="1"><font style="text-align:right">绑定指定的行业：</font></th>
                      <td>
                         	如果沒有绑定行业,则默认为所有行业<br/><!-- 
                               <input type="checkbox" name="ckb_indus" value="1">绑定行业 -->
                           		   		<input type="hidden" name="hdn_indus_id" id="hdn_indus_id" value="445">
...
<select name="s_indus_select[]" id="s_indus_select" multiple="multiple" style="width:160px;float:left;height:200px;overflow-y:scroll;background:white;border:#ccc solid 1px;margin-left:20px;">
          <option id="s_indus_select_op_445" value="445" selected="selected"></option>  </select>
<br class="clear">
...
$('#s_indus_select').append(mod);
                 ...
                 <tr>
                    <th><font style="text-align:right">指定任务模型</font></th>
                       <td>只有指定模型下的被绑定的行业才会被推广<br/>
                         <label for="model_计件悬赏">
<input type="checkbox" id="model_计件悬赏" name="ckb_model[]" value="3" checked="checked">
                            		限定计件悬赏</label><br>
                         <label for="model_多人悬赏">
<input type="checkbox" id="model_多人悬赏" name="ckb_model[]" value="2" >
                            		限定多人悬赏</label><br>
                         <label for="model_订金招标">
<input type="checkbox" id="model_订金招标" name="ckb_model[]" value="5" >
                            		限定订金招标</label><br>
                         <label for="model_单人悬赏">
<input type="checkbox" id="model_单人悬赏" name="ckb_model[]" value="1" >
                            		限定单人悬赏</label><br>
                                                </td>
</tr>
           <tr>
<th><font>任务发布推广者收益</font></th>
<td>
任务发布推广收益模式(固定金额/百分比)<br/>
<label id="pub_task_rake_type">
<input type="radio" id="pub_task_rake_type"  name="pub_task_rake_type" value="1" >按照固定金额</label><font color="red">(此部分推广金由站长自行支付，与任务利润无关。请谨慎配置)</font>
<div id="pub_task_rake_type_child">
<input type="text" size="5" class="txt" name="pub_task_cash" id="pub_task_cash" value="4.00" />现金<input type="text" size="5" class="txt" name="pub_task_credit" id="pub_task_credit" value="4.00" />代金券    </div>

<label id="rake_type2"><input type="radio" id="rake_type2" name="pub_task_rake_type" value="2" checked="checked">按照任务赏金的百分比</label><br/>
<input type="text" size="5" class="txt" name="pub_task_rate" id="pub_task_rate" value="20">%
   </td>
</tr>
                   <tr>
                   <th scope="row"> &nbsp;</th>
