...
<div class="page_title">
    ...
    <div class="tool">
        ...
        <a  class="here" href="index.php?r=prom/bid_task">任务承接</a>
  ...
  <div class="box post">
    <div class="tabcon">
      ...
      <div class="detail">
       <form name="frm_config_basic" id="frm_config_basic" action="index.php?do=prom&view=config&op=bid_task" method="post">
         <input type="hidden" name="op" value="bid_task">
            <div class="gut">
                      ...
                      <td>
                         	如果沒有绑定行业,则默认为所有行业<br/><!-- 
                               <input type="checkbox" name="ckb_indus" value="1">绑定行业 -->
                           		   		<input type="hidden" name="hdn_indus_id" id="hdn_indus_id" value="461">
...
<select name="s_indus_select[]" id="s_indus_select" multiple="multiple" style="width:160px;float:left;height:200px;overflow-y:scroll;background:white;border:#ccc solid 1px;margin-left:20px;">
          <option id="s_indus_select_op_461" value="461" selected="selected"></option>  <option id="s_indus_select_op_462" value="462" selected="selected"></option>  </select>
<br class="clear">
...
<input type="checkbox" id="model_单人悬赏" name="ckb_model[]" value="1" >
           ...
           <tr><th><font>承接任务推广收益</font></th>
<td>
<input type="text" size="5" class="txt" name="bid_task_rake" id="bid_task_rake" value="20" />%
(从任务提成中拿出来分配给推广人的比例)
</td>
</tr>
                  <tr>
