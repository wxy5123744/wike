...
<div class="detail">
 <form action="index.php?do=model&model_id=5&view=config&op=config" method="post">
 	<input type="hidden" name="pk[model_id]" value="5">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
   <th scope="row" width="200">模型名称：</th>
    <td>
       <input type="text" class="txt" name="fds[model_name]" value="订金招标">
</td>
        </tr>
<tr>
...
<label for="satus_no"><input type="radio" id="status_no" name="fds[model_status]"  value="0"> 否</label>
</td>
        </tr>
<tr>
        </tr>
  ...
  <th scope="row" width="200">&nbsp;</th>
    <td>
       <div class="clearfix padt10">
         <button type="submit" name="sbt_edit" class="positive primary pill button" value="1"><span class="check icon"></span>提交</button>
