...
<div class="page_title"><h1>银行认证列表</h1></div>
<!--页头结束-->
...
<form method="post" action="index.php?do=auth&view=list&auth_code=bank&page=1" id="frm_art_search">
<table cellspacing="0" cellpadding="0">
<tbody>
<tr>
<th>认证编号</th>
<td><input type="text" class="txt" name="w[bank_a_id]" 	value="" onkeyup="clearstr(this);"></td>
<th>用户</th>
...
<!--搜索结束-->
<div class="box list">
    	<div class="title"><h2>银行认证列表</h2></div>
        <div class="detail">
