...
<div class="page_title"><h1>邮箱认证列表</h1></div>
<!--页头结束-->
...
<form method="post" action="index.php?do=auth&view=list&auth_code=email&page=1" id="frm_art_search">
<table cellspacing="0" cellpadding="0">
<tbody>
<tr>
<th>认证编号</th>
<td><input type="text" class="txt" name="w[email_a_id]" 	value="" onkeyup="clearstr(this);"></td>
<th>认证用户</th>
...
<div class="box list">
    	<div class="title"><h2>邮箱认证</h2></div>
        <div class="detail">
