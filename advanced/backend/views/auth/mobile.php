...
<div class="page_title"><h1>手机认证列表</h1></div>
<!--页头结束-->
...
<div class="detail" id="detail">
 <form method="post" action="index.php?do=auth&view=list&auth_code=mobile&w[page_size]=&w[mobile_a_id]=&w[username]=&w[auth_status]=" id="frm_art_search">
<table cellspacing="0" cellpadding="0">
<tbody>
<tr>
<th>认证编号</th>
<td><input type="text" class="txt" name="w[mobile_a_id]" 	value="" onkeyup="clearstr(this);"></td>
<th>认证用户</th>
...
<div class="box list">
    	<div class="title"><h2>手机认证列表</h2></div>
        <div class="detail">
        <form action="index.php?do=auth&view=list&auth_code=mobile&w[page_size]=&w[mobile_a_id]=&w[username]=&w[auth_status]=" id='frm_list' method="post">
        	<div id="ajax_dom">
...
<button type="submit" name="sbt_action" value="批量审核"   class="pill positive button" onclick="return batch_act(this,'frm_list');"><span class="icon fork"></span>批量审核</button>
