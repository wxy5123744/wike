...
<div class="page_title">
    <h1></h1>
    <div class="tool">
        <a href="index.php?do=app&&view=message_list" class="here">留言</a>
    </div>
</div>
<div class="box search p_relative">
    ...
    <div class="detail">
        <form method="post" action="index.php?do=app&view=message_list" id="frm_art_search">
           ...
           <tr>
             ...
             <tr>
                 <th>结果排序</th>
                  <td>
             		<select name="ord[]">
                           <option value="comment_id"  selected="selected">默认排序</option>  	
                      </select>
                         <select name="ord[]">
 ...
 <div class="box list">
 	<div class="title">
 	   <h2></h2></div>
  <div class="detail">
  	 <form method="post" action="index.php?do=app&view=message_list" id="frm_list">
