...
<br/>&nbsp;&nbsp;网站名称并非网站标题,仅在页底显示及发送邮件等处使用 
                      ...
                      <tr>
                        ...
                        <td><input type="text" size="50" name="website_url"  value="http://127.0.0.1/weike" maxlength="100" limit="required:true;len:3-100;general:false" msg="网站地址不正确，长度3-100" msgArea="web_url_msg" class="txt"/>
