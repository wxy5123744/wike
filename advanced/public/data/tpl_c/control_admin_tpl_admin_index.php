<?php keke_tpl_class::checkrefresh('control/admin/tpl/admin_index', '1418773997' );?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <div class="user_box">
        ...
        <div class="link_bar">
        	<a href="javascript:;" class="lock" onclick="fresh();" title="<?php echo $_lang['refresh'];?>"><?php echo $_lang['refresh'];?></a> 
         	<a href="javascript:;" class="lock" onclick="del_cache();" title="<?php echo $_lang['clear_cache'];?>"><?php echo $_lang['clear_cache'];?></a> 
